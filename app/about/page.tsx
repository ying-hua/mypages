      ...
      <FadeIn delay={0.1}>
        <div className="mb-12">
          <h1
            ...
            className="text-5xl md:text-6xl font-black text-[#EDE4D8] mb-6 relative inline-block"
          >
            Hi, I&apos;m Astro
          ...
          <div className="flex gap-4">
            <a
              href="https://github.com/ying-hua"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#17171D] border border-[#28283A] text-[#EDE4D8] text-sm hover:border-[#C68B59] hover:text-[#C68B59] transition-colors"
            >
